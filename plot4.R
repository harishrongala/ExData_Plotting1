...
plot(our_df$datetime, our_df$Global_active_power, xlab="", ylab="Global Active Power", type="n")
## Connect dots to draw lines
lines(our_df$datetime, our_df$Global_active_power)
## Plot 2
with(our_df, plot(datetime, Voltage, type="n"))
## Connect dots to draw lines
lines(our_df$datetime, our_df$Voltage)
## Plot 3
## Start the plot with type="n"
...
## Plot 4
with(our_df, plot(datetime, Global_reactive_power, type="n"))
## Connect dots to draw lines
lines(our_df$datetime, our_df$Global_reactive_power)
## Close the device
dev.off()